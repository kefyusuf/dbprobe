...
func (r *runtime) Capabilities() capability.Set {
	return capability.New("activity.sessions", "workload.query_summary")
}
func (r *runtime) Collectors() []collector.Collector {
	return append([]collector.Collector(nil), r.collectors...)
}
