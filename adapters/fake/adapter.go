...
func (fakeAdapter) Metadata() adapter.Metadata {
	return adapter.Metadata{ID: "fake", Name: "Fake", Version: "0.1.0", ContractVersion: adapter.ContractVersion}
}
...
func (fakeAdapter) Open(_ context.Context, spec adapter.TargetSpec, _ adapter.OpenOptions) (adapter.Runtime, error) {
	...
	return newRuntime(adapter.TargetMetadata{Engine: "fake", AdapterID: "fake", Fingerprint: hex.EncodeToString(sum[:8]), DisplayName: "local"}), nil
}
