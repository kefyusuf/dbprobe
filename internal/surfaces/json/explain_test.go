...
func TestRenderExplainUsesVersionedStringPlan(t *testing.T) {
	...
	text := output.String()
	if !strings.Contains(text, "dbprobe.explain/v1alpha1") || !strings.Contains(text, "mysql-json") || strings.Contains(text, "ZXhwbGFpbg==") {
